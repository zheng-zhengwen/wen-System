  ...
  return (
    <div className="space-y-6">
      <div className="space-y-4">
        ...
        <div className="rounded-lg border border-orange-200 bg-orange-50 p-4 border-orange-800 bg-orange-900/20">
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          {allowedTools.map((tool) => (
            <div key={tool} className="flex items-center justify-between rounded-lg border border-green-200 bg-green-50 p-3 border-green-800 bg-green-900/20">
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          {disallowedTools.map((tool) => (
            <div key={tool} className="flex items-center justify-between rounded-lg border border-red-200 bg-red-50 p-3 border-red-800 bg-red-900/20">
      ...
      <div className="rounded-lg border border-blue-200 bg-blue-50 p-4 border-blue-800 bg-blue-900/20">
        <h4 className="mb-2 font-medium text-blue-900 text-blue-100">
          {t('permissions.toolExamples.title')}
        </h4>
        <ul className="space-y-1 text-sm text-blue-800 text-blue-200">
          <li><code className="rounded bg-blue-100 px-1 bg-blue-800">"Bash(git log:*)"</code> {t('permissions.toolExamples.bashGitLog')}</li>
          <li><code className="rounded bg-blue-100 px-1 bg-blue-800">"Bash(git diff:*)"</code> {t('permissions.toolExamples.bashGitDiff')}</li>
          <li><code className="rounded bg-blue-100 px-1 bg-blue-800">"Write"</code> {t('permissions.toolExamples.write')}</li>
          <li><code className="rounded bg-blue-100 px-1 bg-blue-800">"Bash(rm:*)"</code> {t('permissions.toolExamples.bashRm')}</li>
        </ul>
      </div>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          {allowedCommands.map((command) => (
            <div key={command} className="flex items-center justify-between rounded-lg border border-green-200 bg-green-50 p-3 border-green-800 bg-green-900/20">
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          {disallowedCommands.map((command) => (
            <div key={command} className="flex items-center justify-between rounded-lg border border-red-200 bg-red-50 p-3 border-red-800 bg-red-900/20">
      ...
      <div className="rounded-lg border border-purple-200 bg-purple-50 p-4 border-purple-800 bg-purple-900/20">
        <h4 className="mb-2 font-medium text-purple-900 text-purple-100">
          {t('permissions.shellExamples.title')}
        </h4>
        <ul className="space-y-1 text-sm text-purple-800 text-purple-200">
          <li><code className="rounded bg-purple-100 px-1 bg-purple-800">"Shell(ls)"</code> {t('permissions.shellExamples.ls')}</li>
          <li><code className="rounded bg-purple-100 px-1 bg-purple-800">"Shell(git status)"</code> {t('permissions.shellExamples.gitStatus')}</li>
          <li><code className="rounded bg-purple-100 px-1 bg-purple-800">"Shell(npm install)"</code> {t('permissions.shellExamples.npmInstall')}</li>
          <li><code className="rounded bg-purple-100 px-1 bg-purple-800">"Shell(rm -rf)"</code> {t('permissions.shellExamples.rmRf')}</li>
        </ul>
      </div>
    </div>
  );
      ...
      <div className="space-y-4">
        ...
        <div
          className={`cursor-pointer rounded-lg border p-4 transition-all ${permissionMode === 'acceptEdits'
            ? 'border-green-400 bg-green-50 border-green-600 bg-green-900/20'
            : 'border-border bg-card/50 active:border-border active:bg-accent/50'
            }`}
        ...
        <div
          className={`cursor-pointer rounded-lg border p-4 transition-all ${permissionMode === 'bypassPermissions'
            ? 'border-orange-400 bg-orange-50 border-orange-600 bg-orange-900/20'
            : 'border-border bg-card/50 active:border-border active:bg-accent/50'
            }`}
        ...
        >
          <label className="flex cursor-pointer items-start gap-3">
            ...
            />
            <div>
              <div className="flex items-center gap-2 font-medium text-orange-900 text-orange-100">
