...
export default function FolderBrowserModal({
  ...
  return (
    <div className="fixed inset-0 z-[70] flex items-center justify-center bg-black/50 p-4 backdrop-blur-sm">
      <div className="flex max-h-[80vh] w-full max-w-2xl flex-col rounded-lg border border-gray-200 bg-white shadow-xl border-gray-700 bg-gray-800">
        <div className="flex items-center justify-between border-b border-gray-200 p-4 border-gray-700">
          <div className="flex items-center gap-3">
            <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-blue-100 bg-blue-900/50">
              <FolderOpen className="h-4 w-4 text-blue-600 text-blue-400" />
            </div>
            <h3 className="text-lg font-semibold text-gray-900 text-white">Select Folder</h3>
          </div>
            ...
            <button
              ...
              className={`rounded-md p-2 transition-colors ${
                showHiddenFolders
                  ...
                  : 'text-gray-400 hover:bg-gray-100 hover:text-gray-600 hover:bg-gray-700 hover:text-gray-300'
              }`}
        ...
        {showNewFolderInput && (
          <div className="border-b border-gray-200 bg-blue-50 px-4 py-3 border-gray-700 bg-blue-900/20">
            <div className="flex items-center gap-2">
              <Input
                type="text"
                value={newFolderName}
            ...
            <div className="space-y-1">
              {parentPath && (
                <button
                  ...
                  className="flex w-full items-center gap-3 rounded-lg px-4 py-3 text-left hover:bg-gray-100 hover:bg-gray-700"
                >
              ...
              {visibleFolders.length === 0 ? (
                <div className="py-8 text-center text-gray-500 text-gray-400">
                  No subfolders found
                </div>
              ) : (
                visibleFolders.map((folder) => (
                  <div key={folder.path} className="flex items-center gap-2">
                    <button
                      ...
                      className="flex flex-1 items-center gap-3 rounded-lg px-4 py-3 text-left hover:bg-gray-100 hover:bg-gray-700"
                    >
        ...
        <div className="border-t border-gray-200 border-gray-700">
          <div className="flex items-center gap-2 bg-gray-50 px-4 py-3 bg-gray-900/50">
            <span className="text-sm text-gray-600 text-gray-400">Path:</span>
            <code className="flex-1 truncate font-mono text-sm text-gray-900 text-white">
              {currentPath}
            </code>
          </div>
