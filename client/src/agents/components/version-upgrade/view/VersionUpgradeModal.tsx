...
export function VersionUpgradeModal({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            {/* Modal */}
            <div className="relative mx-4 max-h-[90vh] w-full max-w-2xl space-y-4 overflow-y-auto rounded-lg border border-gray-200 bg-white p-6 shadow-xl border-gray-700 bg-gray-800">
                {/* Header */}
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-blue-100 bg-blue-900/30">
                            <svg className="h-5 w-5 text-blue-600 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="space-y-3">
                    <div className="flex items-center justify-between rounded-lg bg-gray-50 p-3 bg-gray-700/50">
                        <span className="text-sm font-medium text-gray-700 text-gray-300">{t('versionUpdate.currentVersion')}</span>
                        <span className="font-mono text-sm text-gray-900 text-white">{currentVersion}</span>
                    </div>
                    <div className="flex items-center justify-between rounded-lg border border-blue-200 bg-blue-50 p-3 border-blue-700 bg-blue-900/20">
                        <span className="text-sm font-medium text-blue-700 text-blue-300">{t('versionUpdate.latestVersion')}</span>
                        <span className="font-mono text-sm text-blue-900 text-blue-100">{latestVersion}</span>
                    </div>
                </div>
                ...
                {releaseInfo?.body && (
                    <div className="space-y-3">
                        <div className="flex items-center justify-between">
                            ...
                            {releaseInfo?.htmlUrl && (
                                <a
                                    ...
                                    className="flex items-center gap-1 text-xs text-blue-600 hover:text-blue-700 hover:underline text-blue-400 hover:text-blue-300"
                                >
                        ...
                        <div className="max-h-64 overflow-y-auto rounded-lg border border-gray-200 bg-gray-50 p-4 border-gray-600 bg-gray-700/50">
                            <div className="prose prose-sm max-w-none whitespace-pre-wrap text-sm text-gray-700 prose-invert text-gray-300">
                ...
                {(updateOutput || updateError) && (
                    <div className="space-y-2">
                        ...
                        <div className="max-h-48 overflow-y-auto rounded-lg border border-gray-700 bg-gray-900 p-4 bg-gray-950">
                            <pre className="whitespace-pre-wrap font-mono text-xs text-green-400">{updateOutput}</pre>
                        </div>
                        {IS_PLATFORM && reloadCountdown !== null && (
                            <div className="rounded-md border border-blue-200 bg-blue-50 px-3 py-2 text-xs text-blue-700 border-blue-900/40 bg-blue-900/20 text-blue-200">
                                {reloadCountdown === 0
                ...
                {!isUpdating && !updateOutput && (
                    <div className="space-y-3">
                        ...
                        <div className="rounded-lg border bg-gray-100 p-3 bg-gray-800">
                            <code className="font-mono text-sm text-gray-800 text-gray-200">
                                {upgradeCommand}
                            </code>
                        </div>
                ...
                <div className="flex gap-2 pt-2">
                    <button
                        onClick={onClose}
                        className="flex-1 rounded-md bg-gray-100 px-4 py-2 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-200 bg-gray-700 text-gray-300 hover:bg-gray-600"
                    >
