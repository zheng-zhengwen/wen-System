...
export default function PrdEditorFooter({ content }: PrdEditorFooterProps) {
  ...
  return (
    <div className="flex flex-shrink-0 items-center justify-between border-t border-gray-200 bg-gray-50 p-3 border-gray-700 bg-gray-800">
      ...
      <div className="text-sm text-gray-500 text-gray-400">Press Ctrl+S to save and Esc to close</div>
    </div>
  );
}
