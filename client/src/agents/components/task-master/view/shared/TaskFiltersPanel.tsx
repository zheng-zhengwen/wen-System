...
export default function TaskFiltersPanel({
  ...
  return (
    <div className="space-y-4 rounded-lg bg-gray-50 p-4 bg-gray-800">
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        <div>
          <label className="mb-1 block text-sm font-medium text-gray-700 text-gray-300">{t('filters.status')}</label>
          <select
            value={statusFilter}
        ...
        <div>
          <label className="mb-1 block text-sm font-medium text-gray-700 text-gray-300">{t('filters.priority')}</label>
          <select
        ...
        <div>
          <label className="mb-1 block text-sm font-medium text-gray-700 text-gray-300">{t('filters.sortBy')}</label>
          <select
      ...
      <div className="flex items-center justify-between">
        ...
        <button onClick={onClearFilters} className="text-sm font-medium text-blue-600 hover:text-blue-700 text-blue-400 hover:text-blue-300">
